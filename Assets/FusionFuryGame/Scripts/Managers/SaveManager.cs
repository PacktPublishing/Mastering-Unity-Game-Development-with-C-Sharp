...
namespace FusionFuryGame
{
    public class SaveManager : MonoBehaviour
    {
        ...
        public static void SaveData(string key, string data, bool saveToCloud = false)
        {
        ...
        private static void SaveToCloud(string jsonData)
        {
            // Simulate cloud saving functionality
            //Just serialize and Deserialize the data with the cloud provided APIs
